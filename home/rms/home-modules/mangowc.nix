...

{
  ...
  xdg.configFile."mango/config.conf".text = ''
    ...
    # Screenshots: region on Print, fullscreen on Super+S.
    bind=NONE,Print,spawn_shell,dir="$HOME/Pictures/Screenshots"; mkdir -p "$dir"; grim -g "$(slurp)" "$dir/screenshot-$(date +%Y%m%d-%H%M%S).png"
    bind=SUPER,S,spawn_shell,dir="$HOME/Pictures/Screenshots"; mkdir -p "$dir"; grim "$dir/screenshot-$(date +%Y%m%d-%H%M%S).png"
